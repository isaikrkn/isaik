const content = {
    ...
    portfolioItems: [
      {
        ...
        type: 'Security / AI',
        status: 'GitHub + demo ready',
        description:
          'A security workflow prototype for triage, analyst assistance, incident context, and AI-supported SOC operations. Use this card for your strongest recruiter-facing security demo.',
        chips: ['SOC', 'AI', 'Automation', 'Python'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      {
        title: 'Audio Event Detection Research',
        type: 'Signal / ML',
        status: 'Research build',
        description:
          'A machine listening and signal-analysis project focused on acoustic event detection, feature extraction, and experimental AI workflows around sound.',
        chips: ['Audio AI', 'Signal', 'Research', 'ML'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      {
        title: 'MetricMaker',
        type: 'Music / Algorithmic Tool',
        status: 'Ongoing project',
        description:
          'A software tool for solving musical metric problems and exploring structured rhythm, notation logic, and computational music practice.',
        chips: ['JavaScript', 'Music theory', 'Algorithms', 'Tooling'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      {
        title: 'Music Notation Studio',
        type: 'Web App / Composition',
        status: 'Browser demo',
        description:
          'A browser-based score writing environment for composition and notation experiments, ready to be shown as a live demo or linked to a repository.',
        chips: ['Node.js', 'Web app', 'Notation', 'Creative coding'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
  ...
  es: {
    ...
    portfolio: {
      label: 'Proyectos / Labs',
      title: 'Proyectos de GitHub, laboratorios y demos',
      intro:
        'Usa esta sección para repositorios, demos en vivo, write-ups técnicos y experimentos ciber-sónicos. Cada tarjeta puede apuntar a GitHub, a una demo o a un caso de estudio.'
    },
    profile: {
      label: 'Perfil',
    ...
    portfolioItems: [
      {
        title: 'AI Security Assistant',
        type: 'Seguridad / IA',
        status: 'GitHub + demo listo',
        description:
          'Un prototipo de flujo de seguridad para triage, asistencia al analista, contexto de incidentes y operaciones SOC apoyadas por IA. Esta tarjeta puede ser tu demo de seguridad más fuerte.',
        chips: ['SOC', 'IA', 'Automatización', 'Python'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      },
      {
        title: 'Audio Event Detection Research',
        type: 'Señal / ML',
        status: 'Build de investigación',
        description:
          'Un proyecto de machine listening y análisis de señal enfocado en detección de eventos acústicos, extracción de características y flujos experimentales de IA alrededor del sonido.',
        chips: ['IA audio', 'Señal', 'Investigación', 'ML'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      {
        title: 'MetricMaker',
        type: 'Música / Herramienta algorítmica',
        status: 'Proyecto en curso',
        description:
          'Una herramienta de software para resolver problemas métricos musicales y explorar ritmo estructurado, lógica de notación y práctica musical computacional.',
        chips: ['JavaScript', 'Teoría musical', 'Algoritmos', 'Tooling'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      {
        title: 'Music Notation Studio',
        type: 'Web App / Composición',
        status: 'Demo en navegador',
        description:
          'Un entorno web para escritura de partituras y experimentos de composición, listo para mostrarse como demo en vivo o enlazarse a un repositorio.',
        chips: ['Node.js', 'Web app', 'Notación', 'Creative coding'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
  ...
  fr: {
    ...
    portfolio: {
      label: 'Projets / Labs',
      title: 'Projets GitHub, laboratoires et démos',
      intro:
        'Utilisez cette section pour des dépôts, démos live, write-ups techniques et expériences cyber-soniques. Chaque carte peut pointer vers GitHub, une démo ou une étude de cas.'
    },
    profile: {
      label: 'Profil',
    ...
    portfolioItems: [
      {
        title: 'AI Security Assistant',
        type: 'Sécurité / IA',
        status: 'GitHub + démo prête',
        description:
          'Un prototype de workflow sécurité pour le triage, l’assistance analyste, le contexte incident et les opérations SOC assistées par IA. Cette carte peut devenir votre meilleure démo sécurité pour les recruteurs.',
        chips: ['SOC', 'IA', 'Automatisation', 'Python'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      },
      {
        title: 'Audio Event Detection Research',
        type: 'Signal / ML',
        status: 'Build de recherche',
        description:
          'Un projet de machine listening et d’analyse du signal focalisé sur la détection d’événements acoustiques, l’extraction de caractéristiques et les workflows IA expérimentaux autour du son.',
        chips: ['IA audio', 'Signal', 'Recherche', 'ML'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      {
        title: 'MetricMaker',
        type: 'Musique / Outil algorithmique',
        status: 'Projet en cours',
        description:
          'Un outil logiciel pour résoudre des problèmes métriques musicaux et explorer le rythme structuré, la logique de notation et la pratique musicale computationnelle.',
        chips: ['JavaScript', 'Théorie musicale', 'Algorithmes', 'Tooling'],
        links: {
          github: '#',
          demo: '#',
          case: '#'
      ...
      },
      {
        title: 'Music Notation Studio',
        type: 'Web App / Composition',
        status: 'Démo navigateur',
        description:
          'Un environnement web pour l’écriture de partitions et les expériences de composition, prêt à être montré comme démo live ou lié à un dépôt.',
        chips: ['Node.js', 'Web app', 'Notation', 'Creative coding'],
        links: {
          github: '#',
          demo: '#',
    ...
    .map(
      (project) => `
        <article class="project-card">
          ...
          <ul>
            ${project.chips.map((chip) => `<li>${chip}</li>`).join('')}
          </ul>
        </article>
      `
    )
...
function renderPortfolio(lang) {
  const items = content[lang].portfolioItems;
      ...
      (item) => `
        <article class="portfolio-card">
          ...
          <ul class="portfolio-chips">
            ${item.chips.map((chip) => `<li>${chip}</li>`).join('')}
          </ul>
          <div class="portfolio-actions">
            <a class="mini-link" href="${item.links.github}" target="${item.links.github === '#' ? '_self' : '_blank'}" rel="noreferrer">${lang === 'es' ? 'GitHub' : lang === 'fr' ? 'GitHub' : 'GitHub'}</a>
            <a class="mini-link" href="${item.links.demo}" target="${item.links.demo === '#' ? '_self' : '_blank'}" rel="noreferrer">${lang === 'es' ? 'Demo' : lang === 'fr' ? 'Démo' : 'Live demo'}</a>
            <a class="mini-link" href="${item.links.case}" target="${item.links.case === '#' ? '_self' : '_blank'}" rel="noreferrer">${lang === 'es' ? 'Caso' : lang === 'fr' ? 'Étude' : 'Case study'}</a>
          </div>
        </article>
      `
    )
...
function applyLanguage(lang) {
  ...
  const pack = content[safeLang];

  document.documentElement.lang = safeLang;
  document.title = pack.meta.title;
  if (metaDescription) metaDescription.setAttribute('content', pack.meta.description);
  ...
  renderPortfolio(safeLang);
  renderServices(safeLang);

  langSwitcher.querySelectorAll('.lang-btn').forEach((button) => {
    const isActive = button.dataset.lang === safeLang;
    button.classList.toggle('active', isActive);
    button.setAttribute('aria-pressed', String(isActive));
  });

  localStorage.setItem('isaik-language', safeLang);
}
...
applyLanguage(localStorage.getItem('isaik-language') || 'en');
